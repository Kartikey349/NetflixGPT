...
const Header = () => {
  ...
  return (
    <div className="h-18 w-full flex items-center px-5 absolute bg-gradient-to-b from-black justify-between z-10">
        ...
        {user && (<div className="flex items-center gap-2">
            ...
            <img className="w-11 h-11 rounded-md" src="https://wallpapers.com/images/hd/netflix-profile-pictures-1000-x-1000-qo9h82134t9nv0j0.jpg" />
